...
echo "Disable set-ryzenadj-curve service..."
systemctl disable set-ryzenadj-curve.service

echo "Disable path listener..."
systemctl disable set-ryzenadj-curve.path
...
rm $remPath"on.sh"
rm $remPath"ryzenadj"
rm $remPath"set-ryzenadj-curve.sh"
...
rm $remPath"set-ryzenadj-curve.path"
rm $remPath"set-ryzenadj-curve.service"
